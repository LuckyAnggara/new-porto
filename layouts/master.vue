<template>
  <div
    class="bg-cover bg-center bg-fixed font-lato"
    style="background-image: url(background.jpg)"
  >
    <div
      class="relative flex backdrop-opacity-80 min-h-screen max-w-screen bg-white/80 p-8"
    >
      <div class="flex flex-col space-y-8 sticky top-50 z-30 w-2/12">
        <NuxtLink
          to="/home"
